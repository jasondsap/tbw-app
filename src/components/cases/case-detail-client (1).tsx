...
import {
  ...
  MoreHorizontal, Edit2, Plus, ExternalLink, Paperclip,
} from 'lucide-react'
...
type TabId = 'overview' | 'notes' | 'goals' | 'consents' | 'records' | 'documents'
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="px-6 pt-5 pb-0">
          ...
          <div className="flex items-center gap-0 border-b-0 -mb-px overflow-x-auto">
            ...
            <TabButton id="documents" label="Documents" icon={Paperclip} activeTab={activeTab} onClick={setActiveTab} />
          </div>
        </div>
      </div>
      ...
      <div className="page-enter">
        ...
        {activeTab === 'documents' && (
          <DocumentsPanel
            ...
            userRole={caseData.user_role ?? 'advocate'}
          />
        )}
      </div>
